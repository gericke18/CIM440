...
var sloth, puppy, dinosaur, seahorse, shark;

var sButton, pButton, dButton, seahorseButton, sharkButton;
...
function preload(){
  ...
  seahorse = loadImage("images/seahorse.jpg");
  shark = loadImage("images/shark.jpg");
}
...
function setup() {
  ...
  sharkButton = createButton("Shark");
  sharkButton.mousePressed(function(){

      currentImage = 3;

  });

  seahorseButton = createButton("Seahorse");
  seahorseButton.mousePressed(function(){
